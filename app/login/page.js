...
function LoginContent() {
  ...
  // Handle NextAuth error redirects (e.g. SSO denied)
  useEffect(() => {
    const authError = searchParams.get("error");
    if (authError === "AccessDenied") {
      setError("Your Google account hasn't been invited to a CaseAssist organization yet. Ask your administrator to invite you first.");
    } else if (authError === "OAuthAccountNotLinked") {
      setError("This email is already registered with a password. Sign in with your email and password instead.");
    } else if (authError) {
