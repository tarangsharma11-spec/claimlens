...
{/* SLIM TOP BAR */}
<nav style={{height:48,padding:"0 16px 0 60px",display:"flex",alignItems:"center",justifyContent:"flex-end",background:"var(--white)",borderBottom:"1px solid var(--card-border)",flexShrink:0,zIndex:90}}>
...
<div style={{padding:"0 10px",marginBottom:16,cursor:"pointer",display:"flex",alignItems:"center",gap:8,overflow:"hidden"}} onClick={()=>nav("home")}>
