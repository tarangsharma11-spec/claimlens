...
<div onMouseEnter={()=>setSideHover(true)} onMouseLeave={()=>setSideHover(false)} className="desktop-nav" style={{width:sideHover?180:52,flexShrink:0,background:"#fff",borderRight:"1px solid var(--card-border)",display:"flex",flexDirection:"column",padding:"12px 0",transition:"width .2s cubic-bezier(.16,1,.3,1)",overflow:"hidden",zIndex:95}}>
...
<div style={{width:32,height:32,borderRadius:8,background:"linear-gradient(135deg, #0062CC, #2EC4B6)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="#fff" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"/></svg></div>
{sideHover&&<span style={{fontSize:14,fontWeight:700,color:"var(--g900)",whiteSpace:"nowrap",letterSpacing:-.3}}>CaseAssist</span>}
</div>
...
{sideHover&&<span style={{fontSize:12,fontWeight:600,letterSpacing:-.1,color:"var(--g700)"}}>{t.label}</span>}
</button>))}
<div style={{flex:1}}/>
<button onClick={()=>signOut({callbackUrl:"/login"})} style={{display:"flex",alignItems:"center",gap:10,padding:"10px",margin:"1px 8px",borderRadius:10,border:"none",background:"transparent",color:"var(--g400)",cursor:"pointer",overflow:"hidden",whiteSpace:"nowrap"}}>
...
{sideHover&&<span style={{fontSize:12,fontWeight:500,color:"var(--g400)"}}>Sign Out</span>}
</button>
</div>
