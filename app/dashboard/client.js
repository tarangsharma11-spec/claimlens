...
const groups=[{label:null,ids:core,collapsible:false},{label:"Tools",ids:tools,collapsible:true,stateKey:"navTools"},{label:"Reference",ids:reference,collapsible:true,stateKey:"navRef"},{label:null,ids:["team"],collapsible:false}];
