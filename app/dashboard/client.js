...
const OPM_POLICIES={
"11-01-01":{title:"Five Point Check",chapter:"Decision-Making",text:"ALL five points required for entitlement: 1) Account in good standing, 2) Worker performing duties of employment, 3) Personal injury by accident or occupational disease, 4) Arising out of and in the course of employment, 5) Resulting disability or loss of earnings. If all five points are met, claim is straightforward, and employer is not disputing — allow immediately.",applies:["all"]},
...
"11-01-03":{title:"Merits and Justice",chapter:"Decision-Making",text:"Must consider all provisions of WSIA/WCA, all applicable OPM policies, and all available evidence. Cannot disregard the Act or established policies. The goal is a fair and just outcome based on individual circumstances.",applies:["all"]},
"11-01-06":{title:"Recurrences",chapter:"Decision-Making",text:"A recurrence is a return of symptoms of a previously allowed injury. Must establish: original injury was work-related, current symptoms relate to original injury, no new intervening cause. Does not require a new accident.",applies:["Recurrence"]},
"11-01-13":{title:"Benefit of Doubt",chapter:"Decision-Making",text:"When evidence is equally balanced after full investigation, favour the claimant. Not a substitute for gathering evidence. Only applies when evidence is genuinely equal after thorough investigation. Must not be used to avoid investigation.",applies:["all"]},
"15-01-01":{title:"Reporting Requirements",chapter:"Claims",text:"Employers: Form 7 within 3 business days of learning of injury. Workers: file claim within 6 months. Health professionals: Form 8 on first visit. Late reporting does not bar a claim but may affect credibility.",applies:["all"]},
"15-02-01":{title:"Work Relatedness",chapter:"Claims",text:'Two-part test: "arising out of" + "in the course of" employment. Both required. Employment must be a significant contributing factor. Does not need to be sole or primary cause.',applies:["all"]},
"15-02-02":{title:"Arising Out of Employment",chapter:"Claims",text:"Employment must be a significant contributing factor to the injury. Pre-existing conditions: if work aggravated, accelerated, or activated a pre-existing condition, the claim is compensable under the thin skull principle.",applies:["all"]},
"15-03-02":{title:"Traumatic Mental Stress",chapter:"Claims",text:"Must result from acute reaction to sudden/unexpected traumatic event(s). Must be clearly and precisely identifiable. Chronic workplace stress is NOT covered under this policy (see 15-03-14).",applies:["Traumatic Mental Stress"]},
"15-03-13":{title:"PTSD First Responders",chapter:"Claims",text:"Presumptive coverage for diagnosed PTSD in first responders (police, fire, paramedics, corrections, dispatchers). Diagnosis from appropriate healthcare practitioner required. Presumption applies unless evidence to the contrary.",applies:["PTSD (First Responder)"]},
"15-03-14":{title:"Chronic Mental Stress",chapter:"Claims",text:"Effective January 1, 2018. Covers chronic mental stress caused by substantial work-related stressor(s). Must be diagnosed by appropriate healthcare professional. Excludes decisions/actions of employer related to employment (hiring, firing, transfers, discipline).",applies:["Chronic Mental Stress"]},
"15-04-01":{title:"Pre-existing Conditions",chapter:"Claims",text:"Thin skull principle: take the worker as you find them. If work injury aggravates, accelerates, or activates a pre-existing condition, the entire resulting disability is compensable. WSIB covers the full disability.",applies:["all"]},
"18-01-01":{title:"Loss of Earnings (LOE)",chapter:"Benefits",text:"Post-1998 injuries: 85% of net average earnings minus post-injury earnings. First 12 weeks based on current employment. After 12 weeks: long-term average considered. LOE review at 72 months — final determination.",applies:["all"]},
"18-02-01":{title:"Non-Economic Loss (NEL)",chapter:"Benefits",text:"For permanent impairment from 1990+ injuries. Assessed using AMA Guides. Lump sum based on % whole person impairment.",applies:["all"]},
"19-01-01":{title:"RTW Obligations",chapter:"Return to Work",text:"Workers: obligation to co-operate in return to work. Employers: obligation to re-employ (if 20+ employees) and accommodate. Modified work: must be productive, meaningful, and consistent with functional abilities.",applies:["all"]},
"19-02-01":{title:"Modified Work",chapter:"Return to Work",text:"Based on Functional Abilities Form (FAF). Must be within documented restrictions. Must be productive and meaningful. Employer must provide details in writing. Progressive return encouraged.",applies:["all"]}
};
...
<div style={{padding:"10px 14px",fontSize:12,color:"var(--g600)",lineHeight:1.65,borderTop:"1px solid var(--card-border)",background:"#fff"}}>{p.text}</div>
</details>))}
