...
<div style={{fontSize:12,color:"var(--g500)",marginTop:2}}>{active.worker} {"\u00B7"} {active.employer} {"\u00B7"} {fmt(active.injuryDate)} {"\u00B7"} {active.injuryType}{active.injuryDate&&active.injuryDate!=="\u2014"&&<span style={{color:"var(--blue)",fontWeight:500}}>{" \u00B7 Day "+daysAgo(active.injuryDate)}</span>}</div>
</div>
