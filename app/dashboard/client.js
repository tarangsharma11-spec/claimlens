...
saveClaim(c)}}catch(err){setMsgs(p=>[...p,{role:"assistant",content:`**Error:** ${err.message}`,ts:new Date().toISOString()}])}finally{setLoading(false)}};
