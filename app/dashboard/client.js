...
<div onMouseEnter={()=>setSideHover(true)} onMouseLeave={()=>setSideHover(false)} className="desktop-nav" style={{width:sideHover?180:52,flexShrink:0,background:"var(--g900)",display:"flex",flexDirection:"column",padding:"12px 0",transition:"width .2s cubic-bezier(.16,1,.3,1)",overflow:"hidden",zIndex:95}}>
...
<div style={{width:32,height:32,borderRadius:8,background:"rgba(255,255,255,.1)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="#fff" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"/></svg></div>
{sideHover&&<span style={{fontSize:14,fontWeight:700,color:"#fff",whiteSpace:"nowrap",letterSpacing:-.3}}>CaseAssist</span>}
</div>
{/* Quick actions in sidebar */}
<div style={{padding:"0 8px",marginBottom:12,display:"flex",flexDirection:sideHover?"row":"column",gap:4}}>
<button onClick={()=>setModal("new")} style={{display:"flex",alignItems:"center",gap:6,padding:sideHover?"7px 12px":"8px",borderRadius:8,border:"none",background:"var(--blue)",color:"#fff",cursor:"pointer",overflow:"hidden",whiteSpace:"nowrap",width:sideHover?"auto":"36px",justifyContent:"center"}}><svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" style={{flexShrink:0}}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15"/></svg>{sideHover&&<span style={{fontSize:11,fontWeight:600}}>New Case</span>}</button>
<button onClick={()=>setShowNotifs(!showNotifs)} style={{display:"flex",alignItems:"center",justifyContent:"center",width:36,height:36,borderRadius:8,border:"none",background:showNotifs?"rgba(255,255,255,.2)":"rgba(255,255,255,.06)",color:"rgba(255,255,255,.7)",cursor:"pointer",position:"relative",flexShrink:0}}><svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0"/></svg>{(()=>{const u=getNotifications(claims).filter(x=>x.type==="urgent").length;return u>0?<span style={{position:"absolute",top:2,right:2,width:14,height:14,borderRadius:"50%",background:"#E53935",color:"#fff",fontSize:8,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center"}}>{u}</span>:null})()}</button>
{sideHover&&<button onClick={()=>setQuickNote({open:true,text:"",caseId:""})} style={{display:"flex",alignItems:"center",justifyContent:"center",width:36,height:36,borderRadius:8,border:"none",background:"rgba(255,255,255,.06)",color:"rgba(255,255,255,.7)",cursor:"pointer",flexShrink:0}}><svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10"/></svg></button>}
</div>
<div style={{height:1,background:"rgba(255,255,255,.08)",margin:"0 10px 8px"}}/>
...
<div style={{flex:1}}/>
<button onClick={()=>signOut({callbackUrl:"/login"})} style={{display:"flex",alignItems:"center",gap:10,padding:"10px",margin:"1px 8px",borderRadius:10,border:"none",background:"transparent",color:"rgba(255,255,255,.4)",cursor:"pointer",overflow:"hidden",whiteSpace:"nowrap"}}>
...
{sideHover&&<span style={{fontSize:12,fontWeight:500}}>Sign Out</span>}
</button>
</div>
