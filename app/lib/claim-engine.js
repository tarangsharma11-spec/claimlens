...
const WORKFLOW_STEPS = [
  { id: "report", phase: "Intake", title: "Report the Injury", checks: [{ id: "form6", label: "Form 6 filed", test: (c) => c.documents?.some((d) => d.tag === "form6") }, { id: "form7", label: "Form 7 filed", test: (c) => c.documents?.some((d) => d.tag === "form7") }, { id: "description", label: "Incident described", test: (c) => (!!c.description && c.description.length > 10) }], actionNav: "documents" },
  { id: "contact", phase: "Intake", title: "Three-Point Contact", checks: [{ id: "worker_contact", label: "Worker contacted", test: (c) => c.threePoint?.worker }, { id: "employer_contact", label: "Employer contacted", test: (c) => c.threePoint?.employer }, { id: "medical_contact", label: "Medical contacted", test: (c) => c.threePoint?.medical }], actionNav: "overview" },
