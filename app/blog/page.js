...
const POSTS = [
  ...
  {
    slug: "how-to-appeal-wsib-denial",
    title: "How to Appeal a WSIB Denial: Step-by-Step Guide",
    excerpt: "A comprehensive walkthrough of the WSIB appeal process, from initial objection through WSIAT, with key OPM policies to cite and evidence strategies.",
    date: "March 13, 2026",
    readTime: "10 min read",
    category: "Appeals",
    keywords: ["WSIB Appeal", "WSIAT", "Objection Process"],
  },
  {
    slug: "wsib-form-7-employer-deadline",
    title: "WSIB Form 7: Employer Filing Deadlines and Penalties",
    excerpt: "Employers must file Form 7 within 3 business days. Here's exactly what's required, what happens if you're late, and how to stay compliant.",
    date: "March 13, 2026",
    readTime: "6 min read",
    category: "Compliance",
    keywords: ["Form 7", "Employer Obligations", "Filing Deadline"],
  },
  {
    slug: "wsib-loss-of-earnings-loe-benefits",
    title: "Understanding WSIB Loss of Earnings (LOE) Benefits: How They're Calculated",
    excerpt: "A detailed breakdown of LOE benefit calculations including the 85% net formula, average earnings, the 72-month final review, and maximum insurable earnings.",
    date: "March 13, 2026",
    readTime: "8 min read",
    category: "Benefits",
    keywords: ["LOE Benefits", "85% Net Earnings", "Average Weekly Wage"],
  },
  {
    slug: "wsib-mental-stress-claims-guide",
    title: "WSIB Claims for Mental Stress: Traumatic vs Chronic (2026 Guide)",
    excerpt: "Understanding the critical differences between traumatic mental stress (OPM 15-03-02), chronic mental stress (15-03-14), and PTSD first responder claims (15-03-13).",
    date: "March 13, 2026",
    readTime: "8 min read",
    category: "Claims",
    keywords: ["Mental Stress", "PTSD", "Chronic Stress"],
  },
  {
    slug: "wsib-pre-existing-conditions-thin-skull",
    title: "Pre-existing Conditions and WSIB: The Thin Skull Principle",
    excerpt: "If a work injury aggravates a pre-existing condition, the entire resulting disability is compensable. Here's how OPM 15-04-01 works and what it means for your claim.",
    date: "March 13, 2026",
    readTime: "6 min read",
    category: "Claims",
    keywords: ["Pre-existing Conditions", "Thin Skull", "Aggravation"],
  },
  {
    slug: "wsib-return-to-work-rights-obligations",
    title: "Return to Work After a WSIB Claim: Your Rights and Obligations",
    excerpt: "Both workers and employers have RTW obligations under the WSIA. Learn about modified duties, FAF requirements, cooperation obligations, and what to do if accommodation fails.",
    date: "March 13, 2026",
    readTime: "7 min read",
    category: "Return to Work",
    keywords: ["Return to Work", "Modified Duties", "FAF"],
  },
  {
  ...
  {
    slug: "wsib-benefit-of-doubt-explained",
    title: "WSIB Benefit of Doubt: When It Applies (and When It Doesn't)",
    excerpt: "OPM 11-01-13 says 'resolve in favour of the claimant' when evidence is equally balanced — but there's more to it. A deep dive into this critical adjudication principle.",
    date: "March 13, 2026",
    readTime: "6 min read",
    category: "Adjudication",
    keywords: ["Benefit of Doubt", "OPM 11-01-13", "Evidence"],
  },
  {
    slug: "wsib-claims-management-software-2026",
    title: "WSIB Claims Management Software: What to Look for in 2026",
    excerpt: "Comparing general legal tools like Clio and Filevine against purpose-built WSIB platforms. Why OPM integration, Five Point Check automation, and PII protection matter.",
    date: "March 13, 2026",
    readTime: "8 min read",
    category: "Technology",
    keywords: ["Claims Software", "Legal Tech", "CaseAssist"],
  },
];
